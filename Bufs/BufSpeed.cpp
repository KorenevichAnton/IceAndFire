...
//---------------------------------------------------------------------------------------------------------------------------------
BufSpeed::BufSpeed(const BufSpeed& _other):
Buf(_other)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
BufSpeed* BufSpeed::createTS(BattleModel* _battleModel, int _bufID)
{
    BufSpeed* pBuf = new BufSpeed();
    if(pBuf)
    {
...
//---------------------------------------------------------------------------------------------------------------------------------
BufSpeed* BufSpeed::copy() const
{
    return new BufSpeed(*this);
}

//---------------------------------------------------------------------------------------------------------------------------------
bool BufSpeed::activate(AnimatedUnitModel* _unit)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void BufSpeed::update(AnimatedUnitModel* _unit, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(model)
    {
