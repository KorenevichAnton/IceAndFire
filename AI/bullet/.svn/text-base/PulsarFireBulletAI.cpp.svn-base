...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarFireBulletAI::PulsarFireBulletAI():
UnitAI(),
initialize(false)
{
    typeUnitAI = PULSAR_FIRE_BULLET_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarFireBulletAI* PulsarFireBulletAI::createTS(BattleModel* _battleModel)
{
    PulsarFireBulletAI* pRet = new PulsarFireBulletAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarFireBulletAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarFireBulletAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits, float _dt)
{
    if(!initialize)
