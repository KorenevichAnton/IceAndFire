...
//---------------------------------------------------------------------------------------------------------------------------------
BulletBulletAI::BulletBulletAI():
UnitAI(),
initialize(false)
{
    typeUnitAI = BULLET_BULLET_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
BulletBulletAI* BulletBulletAI::createTS(BattleModel* _battleModel)
{
    BulletBulletAI* pRet = new BulletBulletAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void BulletBulletAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void BulletBulletAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits, float _dt)
{
    if(!initialize)
