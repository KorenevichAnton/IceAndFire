...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarColdBulletAI::PulsarColdBulletAI():
UnitAI(),
initialize(false)
{
    typeUnitAI = PULSAR_COLD_BULLET_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarColdBulletAI* PulsarColdBulletAI::createTS(BattleModel* _battleModel)
{
    PulsarColdBulletAI* pRet = new PulsarColdBulletAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarColdBulletAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarColdBulletAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits, float _dt)
{
    if(!initialize)
