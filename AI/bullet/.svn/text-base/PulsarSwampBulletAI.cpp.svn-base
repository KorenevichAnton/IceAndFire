...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarSwampBulletAI::PulsarSwampBulletAI():
UnitAI(),
initialize(false)
{
    typeUnitAI = PULSAR_SWAMP_BULLET_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarSwampBulletAI* PulsarSwampBulletAI::createTS(BattleModel* _battleModel)
{
    PulsarSwampBulletAI* pRet = new PulsarSwampBulletAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarSwampBulletAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarSwampBulletAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits, float _dt)
{
    if(!initialize)
