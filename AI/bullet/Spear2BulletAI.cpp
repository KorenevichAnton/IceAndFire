...
//---------------------------------------------------------------------------------------------------------------------------------
Spear2BulletAI::Spear2BulletAI():
UnitAI(),
initialize(false)
{
    typeUnitAI = SPEAR2_BULLET_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
Spear2BulletAI* Spear2BulletAI::createTS(BattleModel* _battleModel)
{
    Spear2BulletAI* pRet = new Spear2BulletAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void Spear2BulletAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void Spear2BulletAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits, float _dt)
{
    if(!initialize)
