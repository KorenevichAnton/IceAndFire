...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarLightBulletAI::PulsarLightBulletAI():
UnitAI(),
initialize(false)
{
    typeUnitAI = PULSAR_LIGHT_BULLET_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
PulsarLightBulletAI* PulsarLightBulletAI::createTS(BattleModel* _battleModel)
{
    PulsarLightBulletAI* pRet = new PulsarLightBulletAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarLightBulletAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void PulsarLightBulletAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray *allUnits, float _dt)
{
    if(!initialize)
