...
//---------------------------------------------------------------------------------------------------------------------------------
FireRainSpellAI::FireRainSpellAI():
UnitAI(),
typeUnitAI(FIRE_RAIN_SPELL_AI),
initialize(false),
remainedCoolDown(0),
position(ccp(0, 0)),
...
//---------------------------------------------------------------------------------------------------------------------------------
FireRainSpellAI* FireRainSpellAI::createTS(BattleModel* _battleModel)
{
    FireRainSpellAI* pRet = new FireRainSpellAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void FireRainSpellAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
    /* here a initialize default parameters
    */
    initCastingArea();
    //modelling
    skin1 = "Textures/Skins/spells/Fire_Rain";
    //
...
//---------------------------------------------------------------------------------------------------------------------------------
void FireRainSpellAI::setPosition(cocos2d::CCPoint _position)
{
    position = _position;
}

//---------------------------------------------------------------------------------------------------------------------------------
void FireRainSpellAI::initCastingArea()
{
    if(position.x > 160)
    {
...
//---------------------------------------------------------------------------------------------------------------------------------
void FireRainSpellAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
...
//---------------------------------------------------------------------------------------------------------------------------------
bool FireRainSpellAI::isAttacked(AnimatedUnitModel* _unit)
{
