...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldShamanMobAI::KoboldShamanMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = KOBOLD_SHAMAN_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldShamanMobAI* KoboldShamanMobAI::createTS(BattleModel* _battleModel)
{
    KoboldShamanMobAI* pRet = new KoboldShamanMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldShamanMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldShamanMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
