...
//---------------------------------------------------------------------------------------------------------------------------------
HumanVillagerMobAI::HumanVillagerMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = HUMAN_VILLAGER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
HumanVillagerMobAI* HumanVillagerMobAI::createTS(BattleModel* _battleModel)
{
    HumanVillagerMobAI* pRet = new HumanVillagerMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void HumanVillagerMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void HumanVillagerMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
