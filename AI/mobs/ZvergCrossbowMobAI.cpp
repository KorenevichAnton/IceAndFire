...
//---------------------------------------------------------------------------------------------------------------------------------
ZvergCrossbowMobAI::ZvergCrossbowMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = ZVERG_CROSSBOW_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
ZvergCrossbowMobAI* ZvergCrossbowMobAI::createTS(BattleModel* _battleModel)
{
    ZvergCrossbowMobAI* pRet = new ZvergCrossbowMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void ZvergCrossbowMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void ZvergCrossbowMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
