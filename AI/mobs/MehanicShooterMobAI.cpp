...
//---------------------------------------------------------------------------------------------------------------------------------
MehanicShooterMobAI::MehanicShooterMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = MEHANIC_SHOOTER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
MehanicShooterMobAI* MehanicShooterMobAI::createTS(BattleModel* _battleModel)
{
    MehanicShooterMobAI* pRet = new MehanicShooterMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void MehanicShooterMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void MehanicShooterMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
