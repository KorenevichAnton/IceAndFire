...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldStaratelMobAI::KoboldStaratelMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = KOBOLD_STARATEL_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldStaratelMobAI* KoboldStaratelMobAI::createTS(BattleModel* _battleModel)
{
    KoboldStaratelMobAI* pRet = new KoboldStaratelMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldStaratelMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldStaratelMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
