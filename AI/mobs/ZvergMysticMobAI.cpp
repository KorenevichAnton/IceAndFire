...
//---------------------------------------------------------------------------------------------------------------------------------
ZvergMysticMobAI::ZvergMysticMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = ZVERG_MYSTIC_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
ZvergMysticMobAI* ZvergMysticMobAI::createTS(BattleModel* _battleModel)
{
    ZvergMysticMobAI* pRet = new ZvergMysticMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void ZvergMysticMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void ZvergMysticMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
...
//---------------------------------------------------------------------------------------------------------------------------------
AnimatedUnitModel* ZvergMysticMobAI::getFriendly(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, int _priority)
{
