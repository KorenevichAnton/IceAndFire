...
//---------------------------------------------------------------------------------------------------------------------------------
DemonSmokeMobAI::DemonSmokeMobAI():
UnitAI(),
initialize(false),
waitAnimation(0),
specialAnimationDuration(0)
{
    typeUnitAI = DEMON_SMOKE_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
DemonSmokeMobAI* DemonSmokeMobAI::createTS(BattleModel* _battleModel)
{
    DemonSmokeMobAI* pRet = new DemonSmokeMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonSmokeMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonSmokeMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
...
//---------------------------------------------------------------------------------------------------------------------------------
AnimatedUnitModel* DemonSmokeMobAI::getEnemy(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, int _priority)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
bool DemonSmokeMobAI::canMove(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonSmokeMobAI::damaged(AnimatedUnitModel* _unitAI, AnimatedUnitModel* _attacker, const UnitAttack* _attack, float& _realDmg)
{
    if(_unitAI->isAlive())
    {
