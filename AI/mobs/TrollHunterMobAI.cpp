...
//---------------------------------------------------------------------------------------------------------------------------------
TrollHunterMobAI::TrollHunterMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = TROLL_HUNTER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
TrollHunterMobAI* TrollHunterMobAI::createTS(BattleModel* _battleModel)
{
    TrollHunterMobAI* pRet = new TrollHunterMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void TrollHunterMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void TrollHunterMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
