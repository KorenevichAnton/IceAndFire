...
//---------------------------------------------------------------------------------------------------------------------------------
ScorpionBlackMobAI::ScorpionBlackMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = SCORPION_BLACK_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
ScorpionBlackMobAI* ScorpionBlackMobAI::createTS(BattleModel* _battleModel)
{
    ScorpionBlackMobAI* pRet = new ScorpionBlackMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void ScorpionBlackMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void ScorpionBlackMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
