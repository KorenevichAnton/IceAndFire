...
//---------------------------------------------------------------------------------------------------------------------------------
MehanicGuardMobAI::MehanicGuardMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = MEHANIC_GUARD_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
MehanicGuardMobAI* MehanicGuardMobAI::createTS(BattleModel* _battleModel)
{
    MehanicGuardMobAI* pRet = new MehanicGuardMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void MehanicGuardMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void MehanicGuardMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
