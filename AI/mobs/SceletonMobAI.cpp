...
//---------------------------------------------------------------------------------------------------------------------------------
SceletonMobAI::SceletonMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = SCELETON_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
SceletonMobAI* SceletonMobAI::createTS(BattleModel* _battleModel)
{
    SceletonMobAI* pRet = new SceletonMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void SceletonMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void SceletonMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
