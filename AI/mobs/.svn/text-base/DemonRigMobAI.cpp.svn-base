...
//---------------------------------------------------------------------------------------------------------------------------------
DemonRigMobAI::DemonRigMobAI():
UnitAI(),
initialize(false),
waitAnimation(0)
{
    typeUnitAI = DEMON_RIG_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
DemonRigMobAI* DemonRigMobAI::createTS(BattleModel* _battleModel)
{
    DemonRigMobAI* pRet = new DemonRigMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonRigMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonRigMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonRigMobAI::damaged(AnimatedUnitModel* _unitAI, AnimatedUnitModel* _attacker, const UnitAttack* _attack, float& _realDmg)
{
    if(_unitAI->isAlive())
    {
