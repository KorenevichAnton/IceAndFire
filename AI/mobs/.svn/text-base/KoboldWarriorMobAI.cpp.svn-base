...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldWarriorMobAI::KoboldWarriorMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = KOBOLD_WARRIOR_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldWarriorMobAI* KoboldWarriorMobAI::createTS(BattleModel* _battleModel)
{
    KoboldWarriorMobAI* pRet = new KoboldWarriorMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldWarriorMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldWarriorMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
