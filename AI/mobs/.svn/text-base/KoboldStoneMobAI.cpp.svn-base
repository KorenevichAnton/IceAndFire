...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldStoneMobAI::KoboldStoneMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = KOBOLD_STONE_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
KoboldStoneMobAI* KoboldStoneMobAI::createTS(BattleModel* _battleModel)
{
    KoboldStoneMobAI* pRet = new KoboldStoneMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldStoneMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void KoboldStoneMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
