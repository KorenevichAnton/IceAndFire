...
//---------------------------------------------------------------------------------------------------------------------------------
ZombieCrossbowMobAI::ZombieCrossbowMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = ZOMBIE_CROSSBOW_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
ZombieCrossbowMobAI* ZombieCrossbowMobAI::createTS(BattleModel* _battleModel)
{
    ZombieCrossbowMobAI* pRet = new ZombieCrossbowMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void ZombieCrossbowMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void ZombieCrossbowMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
...
//---------------------------------------------------------------------------------------------------------------------------------
void ZombieCrossbowMobAI::damaged(AnimatedUnitModel* _unitAI, AnimatedUnitModel* _attacker, const UnitAttack* _attack, float& _realDmg)
{
    if(_unitAI->isAlive())
    {
