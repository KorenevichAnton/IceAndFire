...
//---------------------------------------------------------------------------------------------------------------------------------
TrollTrapperMobAI::TrollTrapperMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = TROLL_TRAPPER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
TrollTrapperMobAI* TrollTrapperMobAI::createTS(BattleModel* _battleModel)
{
    TrollTrapperMobAI* pRet = new TrollTrapperMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void TrollTrapperMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void TrollTrapperMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
