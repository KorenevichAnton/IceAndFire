...
//---------------------------------------------------------------------------------------------------------------------------------
ScorpionRedMobAI::ScorpionRedMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = SCORPION_RED_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
ScorpionRedMobAI* ScorpionRedMobAI::createTS(BattleModel* _battleModel)
{
    ScorpionRedMobAI* pRet = new ScorpionRedMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void ScorpionRedMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void ScorpionRedMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
