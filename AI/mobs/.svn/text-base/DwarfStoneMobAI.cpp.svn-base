...
//---------------------------------------------------------------------------------------------------------------------------------
DwarfStoneMobAI::DwarfStoneMobAI():
UnitAI(),
waitAnimation(0),
initialize(false),
resist(0)
{
    typeUnitAI = DWARF_STONE_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
DwarfStoneMobAI* DwarfStoneMobAI::createTS(BattleModel* _battleModel)
{
    DwarfStoneMobAI* pRet = new DwarfStoneMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void DwarfStoneMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void DwarfStoneMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
...
//---------------------------------------------------------------------------------------------------------------------------------
void DwarfStoneMobAI::damaged(AnimatedUnitModel* _unitAI, AnimatedUnitModel* _attacker, const UnitAttack* _attack, float& _realDmg)
{
    if(_unitAI)
    {
