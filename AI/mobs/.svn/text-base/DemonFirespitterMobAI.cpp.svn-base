#include "DemonFirespitterMobAI.h"
#include "Settings.h"
...
//---------------------------------------------------------------------------------------------------------------------------------
DemonFirespitterMobAI::DemonFirespitterMobAI():
UnitAI(),
initialize(false),
waitAnimation(0),
specialAnimationDuration(0)
{
    typeUnitAI = DEMON_FIRESPITTER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
DemonFirespitterMobAI* DemonFirespitterMobAI::createTS(BattleModel* _battleModel)
{
    DemonFirespitterMobAI* pRet = new DemonFirespitterMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonFirespitterMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
    /* here a initialize default parameters
     */
    specialAnimationDuration = _unitAI->getAdditionalParameter(1);   //waiting time for playing "beginSpecialMove1" and "endSpecialMove1"
    
    initialize = true;
}

//---------------------------------------------------------------------------------------------------------------------------------
void DemonFirespitterMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
...
//---------------------------------------------------------------------------------------------------------------------------------
AnimatedUnitModel* DemonFirespitterMobAI::getEnemy(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, int _priority)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
bool DemonFirespitterMobAI::canMove(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void DemonFirespitterMobAI::damaged(AnimatedUnitModel* _unitAI, AnimatedUnitModel* _attacker, const UnitAttack* _attack, float& _realDmg)
{
    if(_unitAI->isAlive())
    {
