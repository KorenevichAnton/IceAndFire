...
//---------------------------------------------------------------------------------------------------------------------------
HumanArcherMobAI::HumanArcherMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = HUMAN_ARCHER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------
HumanArcherMobAI* HumanArcherMobAI::createTS(BattleModel* _battleModel)
{
    HumanArcherMobAI* pRet = new HumanArcherMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------
void HumanArcherMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------
void HumanArcherMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
