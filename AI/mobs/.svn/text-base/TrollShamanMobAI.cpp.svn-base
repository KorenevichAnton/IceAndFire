...
//---------------------------------------------------------------------------------------------------------------------------------
TrollShamanMobAI::TrollShamanMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = TROLL_SHAMAN_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
TrollShamanMobAI* TrollShamanMobAI::createTS(BattleModel* _battleModel)
{
    TrollShamanMobAI* pRet = new TrollShamanMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void TrollShamanMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void TrollShamanMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
