#include "FrostlingShamanMobAI.h"
#include "Settings.h"
...
//---------------------------------------------------------------------------------------------------------------------------------
FrostlingShamanMobAI::FrostlingShamanMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = FROSTLING_SHAMAN_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
FrostlingShamanMobAI* FrostlingShamanMobAI::createTS(BattleModel* _battleModel)
{
    FrostlingShamanMobAI* pRet = new FrostlingShamanMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void FrostlingShamanMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void FrostlingShamanMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
