#include "FrostlingHunterMobAI.h"
#include "Settings.h"
...
//---------------------------------------------------------------------------------------------------------------------------------
FrostlingHunterMobAI::FrostlingHunterMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = FROSTLING_HUNTER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
FrostlingHunterMobAI* FrostlingHunterMobAI::createTS(BattleModel* _battleModel)
{
    FrostlingHunterMobAI* pRet = new FrostlingHunterMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void FrostlingHunterMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void FrostlingHunterMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
