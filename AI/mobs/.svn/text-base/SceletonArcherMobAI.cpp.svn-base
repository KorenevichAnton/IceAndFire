...
//---------------------------------------------------------------------------------------------------------------------------------
SceletonArcherMobAI::SceletonArcherMobAI():
UnitAI(),
waitAnimation(0),
initialize(false)
{
    typeUnitAI = SCELETON_ARCHER_MOB_AI;
}
...
//---------------------------------------------------------------------------------------------------------------------------------
SceletonArcherMobAI* SceletonArcherMobAI::createTS(BattleModel* _battleModel)
{
    SceletonArcherMobAI* pRet = new SceletonArcherMobAI();
    if(pRet)
...
//---------------------------------------------------------------------------------------------------------------------------------
void SceletonArcherMobAI::init(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits)
{
...
//---------------------------------------------------------------------------------------------------------------------------------
void SceletonArcherMobAI::update(AnimatedUnitModel* _unitAI, const cocos2d::CCArray* _allUnits, float _dt)
{
    if(!initialize)
